                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('admin.settings') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{route('admin.settings')}}">
                            <i class="align-middle" data-feather="settings"></i> <span class="align-middle">
                                Setting</span>
                        </a>
                    </li>
                    <li class="sidebar-header">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('admin.manage.store') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{route('admin.manage.store')}}">
                            <i class="align-middle" data-feather="user"></i> <span class="align-middle">Seller</span>
                        </a>
                    </li>
                    <li class="sidebar-header">
                        Category
                    ...
                    <li class="sidebar-item {{ request()->routeIs('sub_category.create') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{route('sub_category.create')}}">
                            <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ request()->routeIs('sub_category.manage') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{route('sub_category.manage')}}">
                            <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage</span>
                        </a>
                    </li>
                    <li class="sidebar-header">
