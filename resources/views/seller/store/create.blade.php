        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('create.store')}}" method="post">
                    ...
                    <input type="text" class="form-control" name="store_name" id="store_name" placeholder="Asib Store">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary mt-2 w-50 ">Add Store</button>
                    </div>
                </form>
            </div>
        </div>
